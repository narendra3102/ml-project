...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            # Ensure CatBoost working directory exists
            os.makedirs("artifacts/catboost_info", exist_ok=True)
            ...
            models = {
                ...
                "CatBoost Regressor": CatBoostRegressor(verbose=False, train_dir="artifacts/catboost_info"),
